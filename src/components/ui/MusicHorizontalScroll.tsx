...
interface MusicHorizontalScrollProps {
  items: Content[];
  title: string;
  subtitle?: string;
  className?: string;
...
const MusicHorizontalScroll: React.FC<MusicHorizontalScrollProps> = ({
  items,
  title,
  subtitle,
  className = ''
  ...
  return (
    <div className={`mb-12 ${className}`}>
      <div className="container mx-auto px-4">
        <div className="mb-6">
          <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-3 gradient-text">
            {title}
          </h2>
          {subtitle && (
...
export default MusicHorizontalScroll; 